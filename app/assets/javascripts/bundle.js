...
module.exports = {
	"graphQL_address": "http://localhost:8080"
};
...
class IngredientManager {
    ...
    buildAnnotation(name) {
        let _instanceAnnot = new __WEBPACK_IMPORTED_MODULE_3__canvas_annotationsCanvasFactory__["a" /* AnnotationsCanvasFactory */](this.ctx, this.canvasProps);
...
class AnnotationsCanvasFactory {
    ...
    buildAnnotation(res, name) {
        ...
        let filterIngredients = this.ingredients.filter((ingredient, idx) => {
    ...
    appendBulletToCanvas(filterDatas, data, id) {
        ...
        __WEBPACK_IMPORTED_MODULE_1__canvasHelper__["a" /* CanvasHelper */].drawLine(this.createLineOpts(props, id));
        __WEBPACK_IMPORTED_MODULE_1__canvasHelper__["a" /* CanvasHelper */].renderText(this.createTextPos(props, id, data[0]));
    }
