...
/******/ ([
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        "use strict";
        const RATIO_BASE = 1600;
        class Utils {
            static fetchSVG(path, name) {
                if (!self.fetch) {
        ...
        Utils.ASSETS_PATH = './assets/images';
        Utils.asset_path = window.asset_path;
        Utils.calories = {};
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        class DOMUtils {
            static applyStyle(DOMString, DOMType, styleKey, styleValue) {
                ...
                if (DOMType === 'class') {
                    for (let idx = 0; idx < element.length; idx++)
                        styleKey.map((key, idx) => {
                            element[idx].style[key] = styleValue[idx];
                        });
                    return DOMUtils;
                }
                styleKey.map((key, idx) => element.style[key] = styleValue[idx]);
                return DOMUtils;
            }
            static applyTmpl(DOMString, DOMType, tmpl) {
                let element = DOMUtils.getElementFromType(DOMString, DOMType);
                if (DOMType === 'class') {
                    for (let idx = 0; idx < element.length; idx++)
            ...
            static cleanElement(DOMString, DOMType) {
                let element = DOMUtils.getElementFromType(DOMString, DOMType);
                if (DOMType === 'class') {
                    for (let idx = 0; idx < element.length; idx++)
            ...
            static applyClass(DOMString, DOMType, className, mode) {
                let element = DOMUtils.getElementFromType(DOMString, DOMType);
                if (DOMType === 'class') {
                    for (let idx = 0; idx < element.length; idx++) {
            ...
            static toggle(element, mode, className) {
                if (mode === 'add')
                    element.classList.add(className);
                else
                    element.classList.remove(className);
            }
            static hideElement(DOMString, DOMType, timeout) {
                let element = DOMUtils.getElementFromType(DOMString, DOMType);
                if (__WEBPACK_IMPORTED_MODULE_0__utils__["a" /* Utils */].getType(element) === 'Array')
                    for (let idx = 0; idx < element.length; idx++) {
            ...
            static getElementFromType(DOMString, DOMType) {
            ...
            static addEventToElement(DOMString, DOMType, EventType, callback, props) {
            ...
            static setOddEven(idx, componentName) {
            ...
            static addSlick() {
                ...
                __WEBPACK_IMPORTED_MODULE_1_jquery__('.carousel-container').not('.slick-initialized').slick({
                    autoplay: false,
                    infinite: true,
                    vertical: true,
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        const BURGER_SIZE_OPTS = {
            IMG_SIZE: { ratio: __WEBPACK_IMPORTED_MODULE_0__utils_utils__["a" /* Utils */].calculateMainCanvasRatio() },
            CANVAS_SIZE: {
                WIDTH: 1000,
                HEIGHT: 500
            }
        ...
        const burgerHelper = ((OPTIONS) => {
            ...
            const _getSVGElementSize = (img) => {
                return {
                    width: img.width,
                    height: img.height
                };
            };
            const getPath = (idx, name) => {
                let path = '';
                switch (idx) {
                    case 0:
            ...
            return {
                getPathForName: (ingredientName) => {
                    let path = ``;
                    TYPES_AVAILABLE.map((ingredient, idx) => {
                        ingredient.map((name) => {
                ...
                getBeveragePath: (name) => {
                    let bv = BEVERAGES_TYPE.filter((beverage) => {
                ...
                getCondimentPath: (name) => {
                    let condiment = CONDIMENTS_TYPE.filter((condiment) => {
        ...
        /* harmony export (immutable) */ __webpack_exports__["a"] = burgerHelper;
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony export (immutable) */ __webpack_exports__["a"] = GraphQLRoutes;

        GraphQLRoutes.endpoint = {
            method: 'POST',
            uri: 'http://local.dev:8080/graphql'
        };
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        class LocaleSwitcher {
            static ilnHelper(propsName, value, isMisc, idx) {
                let input = __WEBPACK_IMPORTED_MODULE_0__dom__["a" /* DOMUtils */].getElementFromType('myonoffswitch', 'id');
                let lang = input['checked'] === true ? 'fr' : 'en';
                if (isMisc)
                    return FRONT_TEXT.misc[idx][lang];
                return LocaleSwitcher.hydrateTemplate(FRONT_TEXT[propsName][lang], value);
            }
            static hydrateTemplate(text, datas) {
                datas.map((d) => {
                    text = text.replace(/<%- %>/, d);
                });
                return text;
            ...
            static initObserver() {
                __WEBPACK_IMPORTED_MODULE_0__dom__["a" /* DOMUtils */].addEventToElement('myonoffswitch', 'id', 'click', LocaleSwitcher.observerCallback);
            }
            static observerCallback() {
                let input = document.getElementById('myonoffswitch'), locale = input['checked'];
                return locale === true ? window.location.href = '/fr' : window.location.href = '/en';
            }
        }
        /* harmony export (immutable) */ __webpack_exports__["a"] = LocaleSwitcher;
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        class QueryManager {
            constructor(token) {
                this.props = {
                    method: 'POST',
                    uri: `${__WEBPACK_IMPORTED_MODULE_0__config_json__["graphQL_address"]}/graphql`
                };
                this.token = token;
            }
            fetchGraph(queryProps) {
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        "use strict";
        class CanvasHelper {
            static generateCircle(props) {
                let { x, y, radius, endAngle, color, width } = props;
            ...
            static drawLine(props) {
                let { sX, sY, tX, tY, color } = props;
                CanvasHelper.ctx.beginPath();
            ...
            static renderText(props) {
                ...
                texts.map((t, idx) => {
                    ...
                    CanvasHelper.ctx.fillText(t, x, idx === 0 ? y : y + (idx * 11));
                    CanvasHelper.ctx.stroke();
                });
            }
            static setProps(ctx) {
    ...
    /***/ (function(module, exports) {
        ...
        module.exports = {
            "graphQL_address": "http://local.dev:8080"
        };
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_lang__ = __webpack_require__(4);


        class AbstractCanvasManager {
            constructor(id, containerID) {
                this.Locale = __WEBPACK_IMPORTED_MODULE_1__utils_lang__["a" /* LocaleSwitcher */];
                this.canvasID = id;
                this.contID = containerID;
            }
            initCanvas() {
                this.canvas = __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a" /* DOMUtils */].getElementFromType(this.canvasID, 'id');
            ...
            setSize() {
                let container = __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a" /* DOMUtils */].getElementFromType(this.contID, 'id');
                let factor = this.sizing();
            ...
            drawImg(blob, props) {
                ...
                try {
                    this.ctx.drawImage(blob, left, top, width, height);
                    return Promise.resolve();
                }
                catch (e) {
        ...
        /* harmony export (immutable) */ __webpack_exports__["a"] = AbstractCanvasManager;
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_loaderComponentsFactory__ = __webpack_require__(10);
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_switcherMenuComponents__ = __webpack_require__(12);
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_dom__ = __webpack_require__(1);
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_lang__ = __webpack_require__(4);




        (() => {
            let menu = __WEBPACK_IMPORTED_MODULE_1__components_switcherMenuComponents__["a" /* SwitcherMenuComponents */].getComponentsByName('burgers');
            const initCallback = () => {
                menu.initMenuComponent().then(() => __WEBPACK_IMPORTED_MODULE_0__components_loaderComponentsFactory__["a" /* LoaderComponentsManager */].duration = 50)
                    .then(() => {
                        __WEBPACK_IMPORTED_MODULE_2__utils_dom__["a" /* DOMUtils */].applyStyle('overlay', 'id', ['opacity'], ['0'])
            ...
            const addEventSwitcher = () => {
                let textTitle = __WEBPACK_IMPORTED_MODULE_2__utils_dom__["a" /* DOMUtils */].getElementFromType('text-title', 'id');
                __WEBPACK_IMPORTED_MODULE_2__utils_dom__["a" /* DOMUtils */].addEventToElement('selAction', 'class', 'click', function () {
                    let id = parseInt(this.getAttribute('data-id'));
                    let domID = this.id;
                    let name = __WEBPACK_IMPORTED_MODULE_1__components_switcherMenuComponents__["a" /* SwitcherMenuComponents */].switchType(id);
                    let menu = __WEBPACK_IMPORTED_MODULE_1__components_switcherMenuComponents__["a" /* SwitcherMenuComponents */].getComponentsByName(name);
                    __WEBPACK_IMPORTED_MODULE_1__components_switcherMenuComponents__["a" /* SwitcherMenuComponents */].initMenu(menu)
                        .then(() => console.log('init'))
                        .catch((e) => console.log(e));
                    __WEBPACK_IMPORTED_MODULE_1__components_switcherMenuComponents__["a" /* SwitcherMenuComponents */].updateButton(id, domID);
                    textTitle.innerHTML = __WEBPACK_IMPORTED_MODULE_3__utils_lang__["a" /* LocaleSwitcher */].ilnHelper('', [], true, id);
                });
            };
            document.addEventListener('DOMContentLoaded', () => {
                __WEBPACK_IMPORTED_MODULE_0__components_loaderComponentsFactory__["a" /* LoaderComponentsManager */].makeLoader();
                addEventSwitcher();
                initCallback();
            });
        })();
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        class LoaderComponentsManager {
            ...
            static makeLoader() {
                let svg = __WEBPACK_IMPORTED_MODULE_0_d3__["select"](LoaderComponentsManager.svgID).append('svg');
                const dimension = LoaderComponentsManager.getSize({ width: 300, height: 150 }, 2);
                svg.append('g')
        ...
        /* harmony export (immutable) */ __webpack_exports__["a"] = LoaderComponentsManager;

        LoaderComponentsManager.svgID = '#svg-progress';
        LoaderComponentsManager.duration = 10000;
...
// Ignore right-click, since that should open the context menu.
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        class SwitcherMenuComponents {
            static switchType(nextIdx) {
                let _self = SwitcherMenuComponents;
                if (nextIdx > _self.category.length || nextIdx < 0)
                    return;
                return _self.category[nextIdx];
            }
            static getComponentsByName(name) {
                let components;
                switch (name) {
                    case 'burgers':
                        components = new __WEBPACK_IMPORTED_MODULE_1__menuComponents__["a" /* MenuComponents */]();
                        break;
                    case 'beverages':
                        components = new __WEBPACK_IMPORTED_MODULE_2__beverageMenuComponents__["a" /* BeverageMenuComponents */]();
                        break;
                    case 'condiments':
                        components = new __WEBPACK_IMPORTED_MODULE_3__condimentsMenuComponents__["a" /* CondimentsMenuComponents */]();
                        break;
                    default:
                        components = new __WEBPACK_IMPORTED_MODULE_1__menuComponents__["a" /* MenuComponents */]();
                }
            ...
            static updateButton(id, idDOM) {
                let lengthCat = SwitcherMenuComponents.category.length;
                let switchBtn = __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a" /* DOMUtils */].getElementFromType('selAction', 'class');
        ...
        /* harmony export (immutable) */ __webpack_exports__["a"] = SwitcherMenuComponents;

        SwitcherMenuComponents.category = ['burgers', 'beverages', 'condiments'];
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__graphql_queryManager__ = __webpack_require__(5);
        ...
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils_lang__ = __webpack_require__(4);
        ...
        class MenuComponents {
            initMenuComponent() {
                const graphQLDatas = {
                    route: __WEBPACK_IMPORTED_MODULE_2__graphql_queryRoutes__["a" /* GraphQLRoutes */].getAllBurgersQuery(),
                    datas: null
                };
                try {
                    const QueryManagerInstance = new __WEBPACK_IMPORTED_MODULE_1__graphql_queryManager__["a" /* QueryManager */](__WEBPACK_IMPORTED_MODULE_4__utils_utils__["a" /* Utils */].retrieveGraphQLToken());
                    return QueryManagerInstance.fetchGraph(graphQLDatas)
                        .then(res => Promise.resolve(__WEBPACK_IMPORTED_MODULE_3__graphql_queryParser__["a" /* QueryParser */].parseBurgers(res.data.kings)))
                        .then(res => res)
            ...
            <p stlye="text-align: center; padding-top: 20px;">
                ...
                <div class="burger ${classType} items" data-id=${burger.id}>
                    <div class="item-infos">
                        <img src="` + __WEBPACK_IMPORTED_MODULE_4__utils_utils__["a" /* Utils */].asset_path("burger_sample.png") + `"/>
                        <p>${burger.name}</p>
                    </div>
                </div>
            `;
                    __WEBPACK_IMPORTED_MODULE_5__utils_dom__["a" /* DOMUtils */].applyTmpl('menu-items', 'id', tmpl);
                });
            }
            addEventToMenu(className) {
                __WEBPACK_IMPORTED_MODULE_5__utils_dom__["a" /* DOMUtils */].addEventToElement('burger', 'class', 'click', function (props) {
                    const { burger, panel } = props;
                    let id = this.getAttribute('data-id') - 1;
                    if (burger[id] === undefined || burger[id] === null)
                        throw `Burger does not exist with id ${id}`;
                    __WEBPACK_IMPORTED_MODULE_5__utils_dom__["a" /* DOMUtils */].setOddEven(id, 'interact-layout');
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        class PanelComponents {
            ...
            constructIngredientsPanel() {
                ...
                this.burger.ingredients.map((ingredient) => {
                    this.tmpl += `
                        <div class="ingredient" data-name="${ingredient.name}">
                            <hr>
                            <img src="` + __WEBPACK_IMPORTED_MODULE_1__utils_utils__["a" /* Utils */].asset_path(`burgers/${__WEBPACK_IMPORTED_MODULE_2__kings_burgerHelper__["a" /* burgerHelper */].getPathForName(ingredient.name)}`) + `">
                            <p>${ingredient.name}</p>
                        </div>
                    `;
                });
                __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a" /* DOMUtils */].applyTmpl('ingredients-panel', 'id', this.tmpl);
                __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a" /* DOMUtils */].applyClass('ingredients-panel', 'id', 'showPanel', 'add');
                __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a" /* DOMUtils */].applyClass('ingredients-panel', 'id', 'hidePanel', 'rm');
                __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a" /* DOMUtils */].addEventToElement('close-btn', 'id', 'click', this.closeCallback, __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a" /* DOMUtils */]);
                return Promise.resolve('added');
            }
            constructBurger() {
                return __WEBPACK_IMPORTED_MODULE_3__drawingManager__["a" /* controlDrawingManager */](this.burger.ingredients)
                    .then((res) => this.addEventToIngredients(res))
                    .then(() => {
                        let cal = this.burger.ingredients.reduce((a, b) => {
                            if (typeof a === 'number')
                                return a;
                            if (typeof b === 'number')
                                return b;
                        ...
                        let o = __WEBPACK_IMPORTED_MODULE_1__utils_utils__["a" /* Utils */].getCalories();
                        o.burger = cal;
                    })
                    .then(() => __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a" /* DOMUtils */].updateCalories())
            ...
            addEventToIngredients(canvasObject) {
                __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a" /* DOMUtils */]
                    .addEventToElement('ingredient', 'class', 'click', __WEBPACK_IMPORTED_MODULE_4__ingredientManager__["a" /* ingredientCallback */], {
            ...
            clearPanel() {
                __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a" /* DOMUtils */].applyClass('ingredients-panel', 'id', 'hidePanel', 'rm');
                let element = __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a" /* DOMUtils */].getElementFromType('ingredients-panel', 'id');
        ...
        /* harmony export (immutable) */ __webpack_exports__["a"] = PanelComponents;
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        const controlDrawingManager = (ingredients, document = 'burger-container') => {
            let manager = new DrawingManager(document, ingredients);
            try {
                manager.initCanvas();
                return manager.retrieveSVGFromIngredients()
                    .then(() => manager.draw())
                    .then((res) => Promise.resolve([res, manager.getCtx()]))
                    .catch((e) => console.log(e));
            }
            catch (e) {
                return Promise.reject(e);
        ...
        /* harmony export (immutable) */ __webpack_exports__["a"] = controlDrawingManager;

        class DrawingManager {
            constructor(document, ingredients) {
                this.canvasObj = [];
            ...
            initCanvas() {
                ...
                this.canvas = document.getElementById(this.document);
            ...
            setSize() {
                let container = __WEBPACK_IMPORTED_MODULE_2__utils_dom__["a" /* DOMUtils */].getElementFromType('interact-layout', 'id');
            ...
            retrieveSVGFromIngredients(useHelper = true) {
                if (__WEBPACK_IMPORTED_MODULE_1__utils_utils__["a" /* Utils */].getType(this.ingredients) !== 'Array')
                    return Promise.reject('Ingredients is not an array of Ingredients');
                this.ingredients.map((ingredient) => {
                    let ingredientObj = {
                        name: ingredient.name,
                        path: useHelper ? __WEBPACK_IMPORTED_MODULE_1__utils_utils__["a" /* Utils */].asset_path(`burgers/${__WEBPACK_IMPORTED_MODULE_0__kings_burgerHelper__["a" /* burgerHelper */].getPathForName(ingredient.name)}`) : ``,
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        class IngredientsCanvasManager {
            constructor(ingredients, ctx) {
                this.ingredients = ingredients;
                this.ctx = ctx;
            }
            orderIngredients() {
                let breadPosition = [];
                this.ingredients.map((ingredient, idx) => {
                    if (ingredient.name.includes('bread') ||
                        ingredient.name.includes('pain'))
                        breadPosition.push(idx);
                });
                if (breadPosition.length === 0)
                    __WEBPACK_IMPORTED_MODULE_2__ingredientsCanvasDecorator__["a" /* IngredientsCanvasDecorator */].addBread(this.ingredients);
                else
                    __WEBPACK_IMPORTED_MODULE_2__ingredientsCanvasDecorator__["a" /* IngredientsCanvasDecorator */].orderBread(this.ingredients, breadPosition);
            }
            drawSVGElement() {
                ...
                try {
                    this.ingredients.map((ingredient) => {
                        promises.push(__WEBPACK_IMPORTED_MODULE_0__utils_utils__["a" /* Utils */].fetchSVG(ingredient.path, ingredient.name));
                    });
                    return Promise.all(promises)
                        .then(res => {
                            if (__WEBPACK_IMPORTED_MODULE_0__utils_utils__["a" /* Utils */].getType(res) !== 'Array')
                                return Promise.reject('results is not a type of array');
                            let copyRes = __WEBPACK_IMPORTED_MODULE_2__ingredientsCanvasDecorator__["a" /* IngredientsCanvasDecorator */].dataQuickSort(res);
                            copyRes.map((image, idx) => this.createSVGCanvasObject(image, idx, copyRes.length));
                        })
            ...
            createSVGCanvasObject(svgData, idx, length) {
                let img = new Image(), url = self.URL.createObjectURL(svgData), drawDatas;
                img.onload = () => this.drawImage(img, url)
                    .then(res => this.storeCanvasObj(res, idx, length));
                img.src = url;
            }
            drawImage(img, url) {
                const ratio = __WEBPACK_IMPORTED_MODULE_1__kings_burgerHelper__["a" /* burgerHelper */].getRatio();
                let elementSize = __WEBPACK_IMPORTED_MODULE_1__kings_burgerHelper__["a" /* burgerHelper */].getSize(img);
                let left = (this.ctx.canvas.clientWidth / 2) - (img.width / 2 * ratio);
                try {
                    this.ctx.drawImage(img, left, this.imgHeight === undefined ? this.ctx.canvas.clientHeight / 3 : this.imgHeight, elementSize.width, elementSize.height);
        ...
        /* harmony export (immutable) */ __webpack_exports__["a"] = IngredientsCanvasManager;
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        class IngredientsCanvasDecorator {
            static addBread(ingredients) {
            ...
            static orderBread(ingredients, position) {
                let bread = [];
                ...
                let filterIngredient = ingredients.filter((ingredient, idx) => {
                    let find = position.find((id) => {
                        return id === idx;
                    });
            ...
            static dataQuickSort(blobby) {
                let indexes = [];
                let canvasObjectArray = [];
                let breadArray = blobby.filter((blob, idx) => {
        ...
        /* harmony export (immutable) */ __webpack_exports__["a"] = IngredientsCanvasDecorator;

        IngredientsCanvasDecorator.topBread = {
            name: 'top-bread',
            path: __WEBPACK_IMPORTED_MODULE_1__utils_utils__["a" /* Utils */].asset_path(`burgers/${__WEBPACK_IMPORTED_MODULE_0__kings_burgerHelper__["a" /* burgerHelper */].getPathForName('whopper_bread')}`),
            canvasObject: Object.create({}),
        };
        IngredientsCanvasDecorator.bottomBread = {
            name: 'bottom-bread',
            path: __WEBPACK_IMPORTED_MODULE_1__utils_utils__["a" /* Utils */].asset_path(`burgers/${__WEBPACK_IMPORTED_MODULE_0__kings_burgerHelper__["a" /* burgerHelper */].getPathForName('bottom')}`),
            canvasObject: Object.create({}),
        };
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__canvas_annotationsCanvasFactory__ = __webpack_require__(21);





        const ingredientCallback = function (props) {
            console.log(this);
            const { id, obj, ctx } = props;
            let name = this.getAttribute('data-name');
            let token = __WEBPACK_IMPORTED_MODULE_2__utils_utils__["a" /* Utils */].retrieveGraphQLToken();
            let _ingredientInstance = new IngredientManager(id, token);
            return _ingredientInstance.retrieveIngredients()
                .then((res) => _ingredientInstance.setProps(obj, res, ctx))
                .then(() => _ingredientInstance.buildAnnotation(name))
                .then(() => {
                    __WEBPACK_IMPORTED_MODULE_3__utils_dom__["a" /* DOMUtils */].applyClass('ingredients-panel', 'id', 'hidePanel', 'add');
                    __WEBPACK_IMPORTED_MODULE_3__utils_dom__["a" /* DOMUtils */].applyClass('ingredients-panel', 'id', 'showPanel', 'rm');
                })
                .catch((e) => Promise.reject(e));
        };
        /* harmony export (immutable) */ __webpack_exports__["a"] = ingredientCallback;
        ...
        class IngredientManager {
            ...
            retrieveIngredients() {
                let queryInstance = new __WEBPACK_IMPORTED_MODULE_0__graphql_QueryManager__["a" /* QueryManager */](this.token);
                return queryInstance.fetchGraph({
                    route: __WEBPACK_IMPORTED_MODULE_1__graphql_queryRoutes__["a" /* GraphQLRoutes */].getIngredients(),
                    datas: {
                        'id': this.menuID
                    }
                })
            ...
            buildAnnotation(name) {
                let _instanceAnnot = new __WEBPACK_IMPORTED_MODULE_4__canvas_annotationsCanvasFactory__["a" /* AnnotationsCanvasFactory */](this.ctx, this.canvasProps);
                _instanceAnnot.buildAnnotation(this.jsonIng, name);
            }
            setProps(canvasObjProps, res, ctx) {
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        "use strict";
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_lang__ = __webpack_require__(4);
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__canvasHelper__ = __webpack_require__(6);
        ...
        class AnnotationsCanvasFactory {
            ...
            appendBulletToCanvas(filterDatas, data) {
                filterDatas.map((d, idx) => {
                    let props = this.calculateCenter(d.canvasObject);
                    __WEBPACK_IMPORTED_MODULE_1__canvasHelper__["a" /* CanvasHelper */].generateCircle(this.createRadiusOpts(props));
                    __WEBPACK_IMPORTED_MODULE_1__canvasHelper__["a" /* CanvasHelper */].drawLine(this.createLineOpts(props, idx));
                    __WEBPACK_IMPORTED_MODULE_1__canvasHelper__["a" /* CanvasHelper */].renderText(this.createTextPos(props, idx, data[idx]));
                });
            }
            ...
            createRadiusOpts(positionsProps) {
            ...
            createLineOpts(positionsProps, idx) {
        ...
        /* harmony export (immutable) */ __webpack_exports__["a"] = AnnotationsCanvasFactory;
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        class QueryParser {
            static parseBurgers(datas) {
                let burger = [];
                let ingred = [];
                if (__WEBPACK_IMPORTED_MODULE_0__utils_utils__["a" /* Utils */].getType(datas) !== 'Array')
                    return Promise.reject('data not type of Array');
                datas.map((d) => {
                    ingred = [];
                    d.burger.ingredients.map((ing) => {
                        ingred.push({
                    ...
                    let instanceBurger = new __WEBPACK_IMPORTED_MODULE_1__kings_burgerFactory__["a" /* BurgerFactory */](ingred, d.burger.label, d.burger.id);
                    burger.push(instanceBurger.buildBurger());
                });
                return Promise.resolve(burger);
            }
        }
        /* harmony export (immutable) */ __webpack_exports__["a"] = QueryParser;
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        "use strict";
        class BurgerFactory {
            constructor(ingredients, name, id) {
        ...
        /* harmony export (immutable) */ __webpack_exports__["a"] = BurgerFactory;
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        "use strict";
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__graphql_queryManager__ = __webpack_require__(5);
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__graphql_queryRoutes__ = __webpack_require__(3);
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_utils__ = __webpack_require__(0);
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_dom__ = __webpack_require__(1);
        ...
        class BeverageMenuComponents {
            ...
            initMenuComponent() {
                ...
                return this.fetchAllBeverage()
                    ...
                    .then(() => __WEBPACK_IMPORTED_MODULE_3__utils_dom__["a" /* DOMUtils */].addSlick())
                    .catch(e => console.log(e));
            }
            populateSidebar(res) {
                let tmpl = ``;
            ...
            <p stlye="text-align: center; padding-top: 20px;">
                ...
                res.map((beverage, idx) => {
                    ...
                    tmpl += `<div class="beverage ${classType} items" data-id="${beverage.id}">
                        <div class="item-infos">
                            <img src="${__WEBPACK_IMPORTED_MODULE_2__utils_utils__["a" /* Utils */].asset_path(__WEBPACK_IMPORTED_MODULE_4__kings_burgerHelper__["a" /* burgerHelper */].getBeveragePath(beverage.label))}">
                            <p>${beverage.label}</p>
                        </div>
                    </div>
            `;
            ...
            addClickEvent() {
                let callback = function () {
                    ...
                    __WEBPACK_IMPORTED_MODULE_3__utils_dom__["a" /* DOMUtils */].setOddEven(id, 'drink');
                    __WEBPACK_IMPORTED_MODULE_5__beverageComponent__["a" /* beverageCallback */](id);
                };
                __WEBPACK_IMPORTED_MODULE_3__utils_dom__["a" /* DOMUtils */].addEventToElement('beverage', 'class', 'click', callback);
            }
            fetchAllBeverage() {
                let _queryInstance = new __WEBPACK_IMPORTED_MODULE_0__graphql_queryManager__["a" /* QueryManager */](__WEBPACK_IMPORTED_MODULE_2__utils_utils__["a" /* Utils */].retrieveGraphQLToken());
                return _queryInstance.fetchGraph({
                    route: __WEBPACK_IMPORTED_MODULE_1__graphql_queryRoutes__["a" /* GraphQLRoutes */].getAllBeverage(),
                    datas: null
                })
                    .then((res) => Promise.resolve(res))
                    .catch((e) => Promise.reject(e));
        ...
        /* harmony export (immutable) */ __webpack_exports__["a"] = BeverageMenuComponents;
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        const beverageCallback = (menuID) => {
            let _instance = new BeverageComponents(menuID);
            return _instance.getBeverage()
                .then((res) => _instance.triggerDrawing(res))
                .then(() => __WEBPACK_IMPORTED_MODULE_3__utils_dom__["a" /* DOMUtils */].updateCalories())
                .then(() => console.log('done beverage'))
                .catch((e) => console.log(e));
        };
        /* harmony export (immutable) */ __webpack_exports__["a"] = beverageCallback;
        ...
        class BeverageComponents {
            ...
            getBeverage() {
                let token = __WEBPACK_IMPORTED_MODULE_2__utils_utils__["a" /* Utils */].retrieveGraphQLToken();
                let _instance = new __WEBPACK_IMPORTED_MODULE_0__graphql_queryManager__["a" /* QueryManager */](token);
                console.log(`this menu id ` + this.menuID);
                return _instance.fetchGraph({
                    route: __WEBPACK_IMPORTED_MODULE_1__graphql_queryRoutes__["a" /* GraphQLRoutes */].getBeverage(),
            ...
            triggerDrawing(res) {
                let _instance = new __WEBPACK_IMPORTED_MODULE_4__canvas_beverageCanvasManager__["a" /* BeverageCanvasManager */]('beverage', 'drink');
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        class BeverageCanvasManager extends __WEBPACK_IMPORTED_MODULE_0__abstractCanvasManager__["a" /* AbstractCanvasManager */] {
            constructor(id, containerID) {
            ...
            createBeverage(res) {
                ...
                let path = __WEBPACK_IMPORTED_MODULE_2__utils_utils__["a" /* Utils */].asset_path(__WEBPACK_IMPORTED_MODULE_1__kings_burgerHelper__["a" /* burgerHelper */].getBeveragePath(res.label));
                return this.initFacade()
                    .then(() => __WEBPACK_IMPORTED_MODULE_2__utils_utils__["a" /* Utils */].fetchSVG(path, res.label))
                    .then((b) => this._drawFacade(b))
                ...
                return new Promise((resolve, reject) => {
                    img.onload = function () {
                        ...
                        this.drawImg(img, {
                            ...
                            .then((res) => self.URL.revokeObjectURL(url))
                            .then(() => resolve())
                            .catch((e) => console.log(e));
                    }.bind(this);
                });
            ...
            _calculateCalories(res) {
                let cal = __WEBPACK_IMPORTED_MODULE_2__utils_utils__["a" /* Utils */].getCalories();
                cal.beverage = res.calories;
            }
        }
        /* harmony export (immutable) */ __webpack_exports__["a"] = BeverageCanvasManager;
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        class CondimentsMenuComponents {
            ...
            <p stlye="text-align: center; padding-top: 20px;">
                ...
                <div class="item-infos">
                    <img src="${__WEBPACK_IMPORTED_MODULE_2__utils_utils__["a" /* Utils */].asset_path(__WEBPACK_IMPORTED_MODULE_4__kings_burgerHelper__["a" /* burgerHelper */].getCondimentPath(condiment.label))}">
                    <p>${condiment.label}<p>
                </div>
            </div>`;
                });
            ...
            addClickEvent() {
                let callback = function () {
                    ...
                    if (id === NaN)
                        throw 'id is not a type of number';
                    __WEBPACK_IMPORTED_MODULE_3__utils_dom__["a" /* DOMUtils */].setOddEven(id, 'condiments');
                    let canvasCondiments = new __WEBPACK_IMPORTED_MODULE_5__canvas_condimentsCanvasManager__["a" /* CondimentsCanvasManager */](id, 'sidedish', 'condiments');
                    canvasCondiments.loadCondimentPicture()
                        .then((res) => console.log(res))
                        .then(() => __WEBPACK_IMPORTED_MODULE_3__utils_dom__["a" /* DOMUtils */].updateCalories())
                        .catch((e) => console.log(e));
                };
                __WEBPACK_IMPORTED_MODULE_3__utils_dom__["a" /* DOMUtils */].addEventToElement('condiment', 'class', 'click', callback);
            }
            fetchAllCondiments() {
                let _instance = new __WEBPACK_IMPORTED_MODULE_0__graphql_queryManager__["a" /* QueryManager */](__WEBPACK_IMPORTED_MODULE_2__utils_utils__["a" /* Utils */].retrieveGraphQLToken());
                return _instance.fetchGraph({
                    route: __WEBPACK_IMPORTED_MODULE_1__graphql_queryRoutes__["a" /* GraphQLRoutes */].getAllCondiments(),
                    datas: { id: 1 }
                })
                    .then((res) => Promise.resolve(res.data.condiments))
                    .catch((e) => Promise.reject(e));
            }
        }
        /* harmony export (immutable) */ __webpack_exports__["a"] = CondimentsMenuComponents;
    ...
    /***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        class CondimentsCanvasManager extends __WEBPACK_IMPORTED_MODULE_0__abstractCanvasManager__["a" /* AbstractCanvasManager */] {
            constructor(condimentID, id, containerID) {
                super(id, containerID);
                this.condimentID = condimentID;
            }
            loadCondimentPicture() {
                return this.initFacade()
            ...
            _calculateCalories() {
                let cal = __WEBPACK_IMPORTED_MODULE_1__utils_utils__["a" /* Utils */].getCalories();
                cal.condiments = this.condiment.calories;
            }
        }
        /* harmony export (immutable) */ __webpack_exports__["a"] = CondimentsCanvasManager;
