...
class DOMUtils {
    static applyStyle(DOMString, DOMType, styleKey, styleValue) {
        if (DOMType === 'class') {
            let element = document.getElementsByClassName(DOMString);
    ...
    static applyClass(DOMString, DOMType, className) {
        if (DOMType === 'class') {
            let element = document.getElementsByClassName(DOMString);
            for (let idx = 0; idx < element.length; idx++) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_loaderComponentsFactory__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_menuComponents__ = __webpack_require__(5);
...
(() => {
    document.addEventListener('DOMContentLoaded', () => {
        __WEBPACK_IMPORTED_MODULE_1__components_menuComponents__["a" /* MenuComponents */].init().then(res => {
            __WEBPACK_IMPORTED_MODULE_0__components_loaderComponentsFactory__["a" /* LoaderComponentsManager */].duration = 50;
        })
            .then(() => {
            __WEBPACK_IMPORTED_MODULE_2__utils_dom__["a" /* DOMUtils */].applyStyle('overlay', 'id', 'display', 'none !important')
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MenuComponents; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__graphql_queryManager__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__graphql_queryRoutes__ = __webpack_require__(9);
...
const MenuComponents = (() => {
    ...
    const initMenuComponent = () => {
        const graphQLDatas = {
            query: __WEBPACK_IMPORTED_MODULE_1__graphql_queryRoutes__["a" /* QueryRoutes */].ALL,
            datas: {}
        };
        try {
            const QueryManagerInstance = new __WEBPACK_IMPORTED_MODULE_0__graphql_queryManager__["a" /* QueryManager */](__WEBPACK_IMPORTED_MODULE_2__utils_utils__["a" /* Utils */].retrieveGraphQLToken());
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__queryParser__ = __webpack_require__(7);
...
class QueryManager {
    ...
    fetchGraph(props, queryProps) {
        ...
        return fetch(uri, {
            ...
            .then(res => res.json())
            .then(res => Promise.resolve(__WEBPACK_IMPORTED_MODULE_0__queryParser__["a" /* QueryParser */].parseBurgers(res.data.kings)))
            .then(res => res)
            .catch(e => Promise.reject(e));
    }
    static queryBuilder() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__kings_burgerFactory__ = __webpack_require__(8);
...
class QueryParser {
    static parseBurgers(datas) {
        ...
        datas.map((d) => {
            ...
            let instanceBurger = new __WEBPACK_IMPORTED_MODULE_1__kings_burgerFactory__["a" /* BurgerFactory */](ingred, d.burger.label);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return QueryRoutes; });
const QueryRoutes = (() => {
